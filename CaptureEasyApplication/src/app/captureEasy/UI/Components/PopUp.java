...
public class PopUp extends JDialog{
	...
	{
		PopUpInit(title,PopUpType,text,OkButton_Text,cancelButton_Text);
	}
	public void PopUpInit(String title,String PopUpType,String text,String OkButton_Text,String cancelButton_Text) 
	{
		control=false;
		...
		panel_button.setBackground(SystemColor.menu);
